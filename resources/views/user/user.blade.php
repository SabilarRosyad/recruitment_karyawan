            ...
            <div class="p-0 overflow-x-auto">
              <table class="items-center w-full mb-0 text-slate-500 border-gray-200"> <!-- Removed 'align-top' -->
                <thead class="align-bottom">
                  ...
                  <th class="px-6 py-3 font-bold text-left uppercase align-middle bg-transparent border-b border-gray-200 shadow-none text-xxs tracking-none whitespace-nowrap text-slate-400 opacity-70">Action</th>
                  </tr>
                </thead>
                <tbody>
                  @php($no = 1)
                  @foreach ($user as $row)
                    <tr>
                      ...
                      <td class="p-2 pl-8 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                          <a href="{{ route('user.edit', $row->id) }}" class="text-blue-500 text-xs font-semibold leading-tight">
                              <img src="{{ asset('icons/pen.svg') }}" alt="Edit Icon" class="w-4 h-4 inline-block" /> 
                              Edit
                          </a>
                          &nbsp;&nbsp;&nbsp;
                          <a href="javascript:void(0);" class="text-red-500 text-xs font-semibold leading-tight ml-3" onclick="showDeleteModal({{ $row->id }});">
                              <img src="{{ asset('icons/trash.svg') }}" alt="Delete Icon" class="w-4 h-4 inline-block" />
                              Hapus
                          </a>
                      </td>
